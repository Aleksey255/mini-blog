...
import { useReactionContext } from '../../providers/ReactionContext.tsx'
...
export default function ReactionBar({ id }: ReactionBarProps) {
  ...
  const handleReactionClick = (reactionType: Reaction) => {
    setReactions((prevState) => {
      ...
      const updatedReactions: Reaction[] = currentReactions.includes(
        reactionType
      )
    ...
    setSelectedReaction((prev) => (prev === reactionType ? null : reactionType))
  }
